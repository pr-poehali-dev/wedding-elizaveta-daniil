      ...
      <Anim type="card" delay={50}>
        <Card>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {[
              { icon: "🎁", title: "Подарки", text: "Мы будем безмерно рады любому знаку внимания — вашего тёплого присутствия уже более чем достаточно. Но если хочется порадовать нас чем-то материальным, мы будем очень признательны, если подарок уместится в конверт: после праздника нам предстоит долгая дорога домой, и лёгкий багаж — это настоящая забота о нас ♥" },
